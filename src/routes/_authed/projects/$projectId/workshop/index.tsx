...
export const Route = createFileRoute('/_authed/projects/$projectId/workshop/')({
  // Prefetch the article list and the per-article template counts server-side so
  // the left column arrives in the SSR HTML. Templates for the selected article
  // load client-side once a selection is made.
